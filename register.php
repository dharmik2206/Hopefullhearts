...
<!-- Mirrored from themepresss.com/tf/html/sadakat-live/register.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jul 2024 12:32:28 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="col-lg-12">
                    <form class="tp-accountWrapper" action="#">
                        <div class="tp-accountInfo">
                            ...
                            <div class="back-home">
                                <a class="tp-accountBtn" href="index-2.php">
                        ...
                        <div class="tp-accountForm form-style">
                            ...
                            <div class="fromTitle">
                                <h5>Register as:</h5><br>
                            </div>
                            <div style="display: flex; color: white;">
                                <div>
                                    <a href="Regdonor.php"  <button style="background-color: #f67d4a; border-style: none; padding: 5px;">Donor</button></a>
                                </div>
                                <div style="margin-left:10px;">
                                    <a href="Regpickupman.php"  <button style="background-color: #f67d4a; border-style: none; padding: 5px;">Pickupman</button></a>
                                </div>
                            </div><br>
                            <!-- <div class="row">
