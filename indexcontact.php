...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from themepresss.com/tf/html/sadakat-live/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jul 2024 12:32:35 GMT -->
                            ...
                            <div class="contact-form">
                                <form action="https://api.web3forms.com/submit" method="POST" class="contact-validation-active">
                                    ...
                                    <div class="comment-area">
                                        <textarea name="note" id="note" placeholder="Case description*" required></textarea>
                                    </div>
