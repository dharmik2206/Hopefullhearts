...
<li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                                ...
                                <!--  Sidebar End -->
                                <div class="container-fluid" style="margin-left: 750px;">
    <!-- Row 1 -->
    <div class="row">
    <div class="col-lg-6"> <!-- Reduced column size -->
        <!-- Organizer Profile -->
        <div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card overflow-hidden">
                        <div class="card-body p-4">
                            <div class="row align-items-center">
                                ...
                                // Fetch organizer's profile data from the database
                                $sql_organizer = "SELECT * FROM OrganizerMaster WHERE orgId = 1"; // Change the condition as needed
                                $result_organizer = $conn->query($sql_organizer);

                                if ($result_organizer->num_rows > 0) {
                                    // Fetch the first (and presumably only) row as an associative array
                                    $row_organizer = $result_organizer->fetch_assoc();
                                } else {
                                    echo "Organizer profile not found"; // Display an error message if the profile is not found
                                }
                                ?>

                                <h2><u>Organizer Profile</u></h2>
                                <div class="profile-box small-box"> <!-- Added small-box class -->
                                    <br><br> <p><strong>ID:</strong> <?php echo $row_organizer["orgId"]; ?></p>
                                    <p><strong>Username:</strong> <?php echo $row_organizer["orgUserName"]; ?></p>
                                    <p><strong>Email:</strong> <?php echo $row_organizer["orgEmail"]; ?></p>
                                    <p><strong>Street:</strong> <?php echo $row_organizer["orgStreet"]; ?></p>
                                    <p><strong>Area:</strong> <?php echo $row_organizer["orgArea"]; ?></p>
                                    <p><strong>City:</strong> <?php echo $row_organizer["orgCity"]; ?></p>
                                    <p><strong>Pincode:</strong> <?php echo $row_organizer["orgPincode"]; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- End Organizer Profile -->
    </div>
</div>

            <!-- End Pickupman Profile -->
        </div>
    </div>
</div>
