                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="GET" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <select name="date" id="date">
                                ...
                                $distinctDates = array();
                                $result = mysqli_query($conn, "SELECT DISTINCT bookdonationdate FROM bookdonationdetails");
                                while ($row = mysqli_fetch_assoc($result)) {
                                    $distinctDates[] = $row['bookdonationdate'];
                                }
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="GET" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <select name="date" id="date">
                                ...
                                // Fetch distinct dates from the database
                                $distinctDates = array();
                                $result = mysqli_query($conn, "SELECT DISTINCT clothedonationdate FROM clothedonationdetails");
                                while ($row = mysqli_fetch_assoc($result)) {
                                    $distinctDates[] = $row['clothedonationdate'];
                                }
                        ...
                        if (isset ($_GET['date'])) {
                            ...
                            $sql = "SELECT cd.*, dm.donorId 
                                ...
                                WHERE cd.clothedonationdate = '$selectedDate'";
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="GET" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <select name="date" id="date">
                                ...
                                // Fetch distinct dates from the database
                                $distinctDates = array();
                                $result = mysqli_query($conn, "SELECT DISTINCT moneydonationdate FROM moneydonationdetails");
                                while ($row = mysqli_fetch_assoc($result)) {
                                    $distinctDates[] = $row['moneydonationdate'];
                                }
                        ...
                        if (isset ($_GET['date'])) {
                            ...
                            $sql = "SELECT md.*, dm.donorId 
                                ...
                                WHERE md.moneydonationdate = '$selectedDate'";
