...
<!-- Mirrored from themepresss.com/tf/html/sadakat-live/blog-left.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Jun 2022 13:47:13 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col col-md-6 col-sm-7 col-12">
                            <div class="contact-intro">
                                <ul>
                                    <li><i class="fi flaticon-call"></i>+91 8320642719</li>
                                    <li><i class="fi flaticon-envelope"></i>helpinghands@gmail.com</li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="col col-lg-3 col-md-3 col-sm-6">
                                <div class="widget about-widget">
                                    <div class="logo widget-title">
                                        ...
                                        <img class="ft-logo-2" src="assets/images/logo1.png" alt="blog">
                                    </div>
                            ...
                            <div class="col col-lg-2 col-md-3 col-sm-6">
                                <div class="widget link-widget">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="donate.html">Blogs</a></li>
                                        <li><a href="contact.html">Causes</a></li>
                                        <li><a href="event.html">Volunteer</a></li>
                            ...
                            <div class="col col-lg-3 col-lg-offset-1 col-md-3 col-sm-6">
                                <div class="widget market-widget tp-service-link-widget">
                                    ...
                                    <div class="contact-ft">
                                        <ul>
                                            <li><i class="fi flaticon-pin"></i>28 Street,Bardoli,Surat,India</li>
                                            <li><i class="fi flaticon-call"></i>+91 8320642719</li>
                                            <li><i class="fi flaticon-envelope"></i>helpinghands@gmail.com</li>
                                        </ul>
                                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col col-xs-12">
                                <p class="copyright">&copy; 2021 HeplingHands. All rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
